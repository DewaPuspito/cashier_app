    ...
    <table className="min-w-full text-sm text-left text-gray-700">
      ...
      {Array.isArray(data) && data.length > 0 ? (
        data.map((cashier, index) => (
            ...
            <td  className="whitespace-nowrap px-4 py-3 text-center text-gray-700">{cashier.name}</td>
            <td  className="whitespace-nowrap px-4 py-3 text-center text-gray-700">{cashier.email}</td>
